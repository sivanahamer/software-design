...
<span style="color:#ffc890; font-weight:bold">Abstract Factory</span> : Declara una interfaz en donde se crean los objetos abstractos relacionados, no tienen clase concreta.
